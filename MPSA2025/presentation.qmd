...
format:
  revealjs: 
    html: true
    logo: _SharedFolder/images/logo.png
    theme: default
    css: custom.css
---
...
![](_SharedFolder/graphs/dict_use-case.png){fig-align="center"}
...
![](_SharedFolder/graphs/F1_score.png){fig-align="center"}

## 
<h2 style="text-align: center;">Sentiment F1 Scores</h2>
<div style="margin-bottom: 50px;"></div>

![](_SharedFolder/graphs/F1_score_sentiment.png){fig-align="center"}

## Preliminary Findings
<div style="margin-bottom: 50px;"></div>

- LLMs are able to annotate to an acceptable threshold to consider process automation.
- Hints at the importance of testing different methods and models to find which is best suited for their project.
